...
import QRcodeUnknown from '../components/AgentSpace/vendor/QRcodeUnknown.svg';
      ...
      .then(response => {
        if (!response.data.hasOwnProperty('errors')) {
          this.props.signInDispatcher(
            ...
            response.data.signIn.user._id
          );
          this.props.setRoleDispatcher(response.data.signIn.user.role.name);
          if (
            response.data.signIn.user.role.name == 'agent_in' ||
            response.data.signIn.user.role.name == 'agent_out' ||
            response.data.signIn.user.role.name == 'agent_workshop'
          )
