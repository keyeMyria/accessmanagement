      ...
      <Grow in={true}>
        <li>
          <time
            ...
            <span className="day">
              {dateFormat(this.props.start_date, 'dd')}
            </span>
            <span className="month">
              {dateFormat(this.props.start_date, 'mmm')}
            </span>
            <span className="year">
              {dateFormat(this.props.start_date, 'yyyy')}
            </span>
          </time>
          <div
            className="info"
          ...
          <div>
            ...
            <Menu
              ...
              <MenuItem onClick={() => this.handleEditEvent(this.props)}>
                {' '}
                Edit Event{' '}
              </MenuItem>
              <MenuItem onClick={() => this.deleteEvent(this.props._id)}>
                {' '}
                Archive Event{' '}
              </MenuItem>
            </Menu>
